$(document).ready(function (e) {
    SetProgressTime(null, "2017/12/11 0:00:00", "2017/12/16 0:00:00")
});
var _index = 0;//进度
...
function SetProgressTime(fun, startTime, endTime) {
    ...
    for(var i = 0; i < dateNum; i ++){
        ...
        str += '<div>' +
            '<span>03</span><span>06</span><span>09</span><span>12</span><span>15</span><span>18</span><span>21</span><br/>' +
            ''+week + ' ' + monthNum+'</div>';
    }
    $(".time_slot").html(str);
